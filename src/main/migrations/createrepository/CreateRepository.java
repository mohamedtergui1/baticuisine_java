        ...
        try {
            ...
            if (file.createNewFile()) {
                ...
                try (FileWriter writer = new FileWriter(file)) {
                    writer.write("package main.java.com.app.repository;\n" +
                            "\n" +
                            ...
                            "\n" +
                            "public class " + className + "RepositoryImpl extends Orm<" + className + "> implements BaseRepository<" + className + ",Integer> {\n" +
                            "\n" +
                            "\n" +
                            "    @Override\n" +
